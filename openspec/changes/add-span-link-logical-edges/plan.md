...
- **`pkg/build/routeprescan_test.go`**:LinkSeries_EmitsBothViaKeys(server key 的 callerCluster = server pod 自己的 cluster);DedupsWithPlainNetworkSeriesKey;viaRouteKey skip 鏈各 case;ServerUnknownLinkSeries_SingleKey;既有測試全綠。
